...
{{--                                                    </select>--}}
                                ...
                                <div class="span10">
                                    <form class="form-horizontal" action="{{ route('import_advance') }}" method="post"
                                          enctype="multipart/form-data">
                                        @csrf
                                        <div class="span4">
                                            <div class="control-group">
                                                <label class="control-label" for="fileInput">导入事前申请单</label>
                                                <div class="controls">
                                                    <input class="input-file uniform_on" name="advanceRequisition"
                            ...
                            <table class="table table-bordered">
                                ...
                                @foreach($zuoxf_renlbs as $zuoxf_renlb)
                                    <tr>
                                        ...
                                        <td>{{$zuoxf_renlb->train_date ? \Carbon\Carbon::parse('1900-1-1')->addDays($zuoxf_renlb->train_date)->format('Y-m-d') : ''}}</td>
                                        <td>{{\Carbon\Carbon::parse('1900-1-1')->addDays($zuoxf_renlb->entry_date)->format('Y-m-d')}}</td>
