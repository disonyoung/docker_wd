...
{{--                                </fieldset>--}}
{{--                            </form>--}}
                            <a href="{{ route('itembyname.create.xieyi_id',['xieyi_id'=>$xieyi_id]) }}" >添加关联项目</a>
                        </div>
                    </div>
                    <!-- /block -->
                </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                    @foreach($itembynames as $itembyname)
                                        <tr>
                                            <td>{{$itembyname->id}}</td>
                                            <td>{{$itembyname->item_byname}}</td>
                                            <td>{{$itembyname->xieyi->agreement}}</td>
                                            <td>@if($itembyname->item_id === null)@else $itembyname->item->name @endif </td>
                                            <td></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
